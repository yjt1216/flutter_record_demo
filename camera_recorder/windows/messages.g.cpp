...
const flutter::StandardMessageCodec& CameraApi::GetCodec() {
  return flutter::StandardMessageCodec::GetInstance(&CameraApiCodecSerializer::GetInstance());
}
...
void CameraApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.getAvailableCameras" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.create" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.initialize" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.dispose" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.takePicture" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          api->TakePicture(camera_id_arg, file_path_arg, [reply](ErrorOr<std::string>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.startVideoRecording" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          const auto& file_path_arg = std::get<std::string>(encodable_file_path_arg);
          api->StartVideoRecording(camera_id_arg, file_path_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.stopVideoRecording" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.pausePreview" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.resumePreview" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.camera_recorder.CameraApi.setMirrorPreview" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          ...
          api->SetMirrorPreview(camera_id_arg, mirror_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
...
void CameraEventApi::CameraClosing(
  ...
  const std::string channel_name = "dev.flutter.pigeon.camera_recorder.CameraEventApi.cameraClosing" + message_channel_suffix_;
...
void CameraEventApi::Error(
  ...
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.camera_recorder.CameraEventApi.error" + message_channel_suffix_;
  BasicMessageChannel<> channel(binary_messenger_, channel_name, &GetCodec());
